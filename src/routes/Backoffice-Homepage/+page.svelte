<div class="mx-auto w-full text-white text-center h-full">
    ...
    <div class="relative isolate bg-gradient-to-t from-[#B5BAE4] to-[#FFFFFF] h-full">
        ...
        <!-- หัวด้านบน -->
        <div class="bg-[#B5BAE4] h-[70px] sm:h-[90px] md:h-[100px] w-screen flex items-center justify-center">
            ...
            <div class="absolute right-5 sm:right-8 md:right-10 flex items-center space-x-3 sm:space-x-4 md:space-x-5 lg:space-x-10">
                <!-- Button Manage -->
                <button>
                    <a href="/Homepage-Admin" class="bg-white text-[#2C2C2C] text-xs sm:text-sm md:text-lg lg:text-xl font-semibold px-3 py-1 sm:px-4 sm:py-2 border border-gray-300 rounded-3xl hover:bg-gray-100 drop-shadow-md">Manage</a>
                </button>

                <!-- Button Products -->
                <button>
                    <a href="/product">
                        <h1 class="text-xs sm:text-sm md:text-lg lg:text-xl font-semibold text-[#2C2C2C]">Products</h1>
                    </a>
                </button>
                ...
                <button>
                    <a href="/history">
                        <h1 class="text-xs sm:text-sm md:text-lg lg:text-xl font-semibold text-[#2C2C2C]">History</h1>
                    </a>
                </button>
                ...
                <button>
                    <a href="/topup">
                        <h1 class="text-xs sm:text-sm md:text-lg lg:text-xl font-semibold text-[#2C2C2C]">Top-up</h1>
                    </a>
                </button>
                ...
                <button>
                    <a href="/profile">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="h-[30px] sm:h-[40px] md:h-[50px] lg:h-[80px] w-[30px] sm:w-[40px] md:w-[50px] lg:w-[80px]">
                ...
                <button class="flex items-center">
                    <a href="/topup" class="flex items-center">
                        <img src="../src/lib/images/Diamond.png" alt="coin" class="h-[15px] sm:h-[20px] md:h-[30px] lg:h-[40px] w-[15px] sm:w-[20px] md:w-[30px] lg:w-[40px]">
                        <h1 class="text-xs sm:text-sm md:text-lg lg:text-xl font-semibold text-[#2C2C2C] ml-1 md:ml-2">0</h1> 
                    </a>
                </button>
            </div>
        </div>
        ...
        <div class="flex flex-col items-center h-screen text-center py-[70px] sm:py-[100px] md:py-[150px] lg:py-[200px]">
            <div class="relative flex mb-10">
                <h1 class="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold text-[#2C2C2C]">YouTubePreAcc</h1>
            </div>    
            
            <button>
                <h1 class="text-[#2C2C2C] font-semibold text-base sm:text-lg md:text-xl lg:text-2xl bg-[#FFE3DE] flex items-center justify-center rounded-3xl px-2 py-1 sm:px-4 sm:py-2 drop-shadow-md">
