    ...
    <div class="relative isolate bg-gradient-to-t from-[#B5BAE4] to-[#FFFFFF] h-screen">
        ...
        <div class="bg-[#B5BAE4] h-[70px] md:h-[100px] w-full flex items-center justify-between px-4">
            ...
            <div class="flex items-center space-x-4 md:space-x-6 lg:space-x-8">
                <button>
                    <a href="/product">
                        <h1 class="underline font-mitr font-regular text-sm md:text-lg lg:text-xl text-[#2C2C2C]">Products</h1>
                    </a>
                </button>
            ...
            <div class="flex flex-col items-center">
                <button class="flex flex-col items-center justify-center bg-[#FFE3DE] rounded-3xl shadow-md p-5 md:p-8 w-[90%] md:w-[400px] h-[500px]">
                    <a href="/product-detail-1">
                        ...
                        <h1 class="font-mitr font-regular text-3xl md:text-3xl text-[#2C2C2C] mb-4 md:mb-6">1 MONTH</h1> 
                        ...
                        <h1 class="font-mitr font-regular text-2xl md:text-3xl text-[#2C2C2C]">IN STOCK 20</h1> 
                    </a>
                </button>
                
                <button class="mt-4">
                    <a href="/login" class="font-mitr font-regular bg-white text-lg md:text-xl text-[#2C2C2C] px-4 py-2 border border-gray-300 rounded-3xl hover:bg-gray-100 drop-shadow-md">Order now</a>
                </button>
            </div>
            ...
            <div class="flex flex-col items-center">
                <button class="flex flex-col items-center justify-center bg-[#FFE3DE] rounded-3xl shadow-md p-5 md:p-8 w-[90%] md:w-[400px] h-[500px]">
                    <a href="/product-detail-12">
                        ...
                        <h1 class="font-mitr font-regular text-3xl md:text-3xl text-[#2C2C2C] mb-4 md:mb-6">12 MONTH</h1> 
