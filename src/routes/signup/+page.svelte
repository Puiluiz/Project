        ...
        <div class="flex items-center justify-center py-[100px]">
            ...
            <!-- ด้านซ้าย -->
                ...
                <div class="flex flex-col w-1/2 space-y-4">
                    ...
                    <label for="Name" class="block text-[#2C2C2C] font-semibold text-left text-2xl mb-1">Username</label>
                    ...
                    <div class="flex justify-end items-center">
                        <button><a href="/login" class="bg-white text-[#2C2C2C] px-4 py-2 border border-gray-300 rounded-3xl hover:bg-gray-100 drop-shadow-md">Sign up</a></button>
                    </div>
                </div>
            </div>      
        </div>
