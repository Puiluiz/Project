<div class="mx-auto w-full text-white text-center h-full">
    ...
    <div class="relative isolate bg-gradient-to-t from-[#B5BAE4] to-[#FFFFFF] h-screen">
        ...
        <!-- หัวด้านบน -->
        <div class="bg-[#B5BAE4] h-[100px] flex items-center justify-between px-5 md:px-10"> 

            <div class="flex items-center">
                <button>
                    <h1 class="text-[#2C2C2C] font-semibold text-xl md:text-2xl bg-[#FFE3DE] flex items-center justify-center rounded-3xl px-4 py-2">
        ...
        <div class="flex items-center justify-center py-10 md:py-20">
            <div class="bg-[#FFE3DE] rounded-2xl shadow-md p-5 md:p-10 max-w-4xl w-full flex flex-col md:flex-row items-center justify-center">

                <!-- ด้านซ้าย -->
                <div class="text-center md:mr-10">
                    <h1 class="text-4xl md:text-6xl text-[#2C2C2C] font-semibold mb-6">Log in</h1>
                    <div class="flex items-center justify-center my-6">
                        <div class="border-t border-[#2C2C2C] w-[80px] md:w-[100px]"></div>
                    ...
                    <div class="flex justify-center space-x-4">
                        ...
                        <button>
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256" class="h-[50px] w-[60px] mr-10 drop-shadow-md bg-white p-2 rounded-full shadow-md">
                                ...
                                <defs><clipPath id="skillIconsDiscord0"><path fill="#fff" d="M28 51h200v154.93H28z"/></clipPath></defs></g>
                            </svg>
                        </button>
                        <!-- เพิ่มไอคอน Facebook -->
                        <button>
                ...
                <div class="flex flex-col w-full md:w-1/2 space-y-4">
                    <label for="email" class="block text-[#2C2C2C] font-semibold text-left text-xl md:text-2xl mb-1">Email</label>
                    ...
                    <label for="Name" class="block text-[#2C2C2C] font-semibold text-left text-xl md:text-2xl mb-1">Username</label>
                    <input type="text" placeholder="Username" class="w-full p-3 rounded-2xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#B5BAE4] text-[#2C2C2C]">

                    <label for="password" class="block text-[#2C2C2C] font-semibold text-left text-xl md:text-2xl mb-1">Password</label>
                    ...
                    <div class="flex justify-end items-center">
                        <button>
                            <a href="/login" class="bg-white text-[#2C2C2C] px-4 py-2 border border-gray-300 rounded-3xl hover:bg-gray-100 drop-shadow-md">Sign up</a>
                        </button>
                    </div>
                </div>
            </div>      
