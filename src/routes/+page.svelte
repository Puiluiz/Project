<div class="mx-auto w-full text-white text-center">
    ...
    <div class="relative isolate overflow-hidden bg-gradient-to-t from-[#B5BAE4] to-[#FFFFFF] h-screen">
        ...
        <div class="bg-[#B5BAE4] h-[100px] w-screen flex items-center justify-center "> 
            ...
            <div class=" absolute left-10">
                <button><h1 class="text-[#2C2C2C] font-semibold text-2xl bg-[#FFE3DE] flex items-center justify-center rounded-3xl px-4 py-2"><svg xmlns="http://www.w3.org/2000/svg" width="1.43em" height="1em" viewBox="0 0 256 180" class = "mr-2 ">
                    ...
                    <path fill="#fff" 
                    d="m102.421 128.06l66.328-38.418l-66.328-38.418z"/></svg><a href="/">YouTubePreAcc</a></h1>
                </button>
                
            </div>

            <div class="absolute right-10">
                <button><h1 class="text-2xl text-[#2C2C2C] font-semibold bg-[#FFE3DE] flex items-center justify-center rounded-3xl font-semibold px-4 py-2 "> <a href="/login">Log in</a></h1>
                </button>
            </div>
        </div>
        ...
        <div class="flex flex-col items-center h-screen text-center py-[250px]">
            ...
            <button><h1 class="text-[#2C2C2C] font-semibold text-2xl bg-[#FFE3DE] flex items-center justify-center rounded-3xl px-4 py-2 drop-shadow-md">
        ...
        <div class="absolute bottom-0 bg-[#B5BAE4] h-[100px] w-screen flex justify-center items-center">
            ...
            <button class="flex flex-col items-center justify-center bg-transparent">
                <a href="/">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 128 128" class="h-[50px] w-[60px] mr-10 drop-shadow-md bg-white p-2 rounded-full"><rect width="118.35" height="118.35" x="4.83" y="4.83" fill="#3d5a98" rx="6.53" ry="6.53"/>
                        <path fill="#fff" d="M86.48 123.17V77.34h15.38l2.3-17.86H86.48v-11.4c0-5.17 1.44-8.7 8.85-8.7h9.46v-16A127 127 0 0 0 91 22.7c-13.62 0-23 8.3-23 23.61v13.17H52.62v17.86H68v45.83z"/></svg>
                </a>
            </button>
