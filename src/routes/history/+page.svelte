            ...
            <div class="absolute right-10 flex justify-center items-center h-[100px]">
                ...
                <button class="flex items-center ml-20"> 
                    <a href="/history" class="flex items-center">
                        <h1 class="underline decoration-[#2C2C2C] text-xl font-semibold text-[#2C2C2C] ">History</h1>
                    </a>
                </button>
        ...
        <div class="flex flex-col items-center h-screen text-center py-[250px]">
            ...
            <table class="border-collapse border border-slate-500">
                ...
                <tbody>
                  ...
                  <tr>
                    <th class="border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-5">003</th>
                    <th class="border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-5">C000</th>
                    <th class="border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-5">TOP-UP</th>
                    <th class="border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-5">20</th>
                    <th class="border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-5">20</th>
                    <th class="border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-5">-</th>
                    <th class="border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-5">DONE</th>
                  </tr>
