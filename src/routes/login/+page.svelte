            ...
            <!-- ด้านซ้าย -->
                <div class="text-center mr-20">
                    ...
                    <div class="flex justify-center space-x-4">
                        ...
                        <!-- เพิ่มไอคอน Facebook -->
                        <button>
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 128 128" class="h-[50px] w-[60px] mr-10 drop-shadow-md bg-white p-2 rounded-full shadow-md"><rect width="118.35" height="118.35" x="4.83" y="4.83" fill="#3d5a98" rx="6.53" ry="6.53"/>
                ...
                <div class="flex flex-col w-1/2 space-y-4">
                    <label for="Email" class="block text-[#2C2C2C] font-semibold text-left text-2xl mb-1">Email or Username</label>
                    <input type="Email" placeholder="Email or Username" class="w-full p-3 rounded-2xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#B5BAE4] text-[#2C2C2C]">
                    ...
                    <div class="flex justify-end items-center">
                        ...
                        <button><a href="/Home-login" class="bg-white text-[#2C2C2C] px-4 py-2 border border-gray-300 rounded-3xl hover:bg-gray-100 drop-shadow-md">Log in</a></button>
                    </div>
                </div>
            </div>      
        </div>
