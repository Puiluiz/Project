    ...
    <div class="relative isolate bg-gradient-to-t from-[#B5BAE4] to-[#FFFFFF] h-full">
       ...
       <div class="bg-[#B5BAE4] h-[60px] md:h-[80px] lg:h-[100px] w-full flex items-center justify-between px-4">
        ...
        <div class="flex items-center space-x-2 sm:space-x-4 lg:space-x-8">
            ...
            <button>
                <a href="/Manage-User" class="underline font-mitr font-regular text-xs sm:text-sm md:text-lg text-[#2C2C2C]">Manage-User</a>
            </button>

            <button>
                <a href="/Log-Product" class="font-mitr font-regular text-xs sm:text-sm md:text-lg text-[#2C2C2C]">Log</a>
            </button>
            ...
            <table class="table-auto border-collapse border border-slate-500 w-full max-w-full overflow-x-auto">
                <thead>
                    <tr>
                        ...
                        <th class="font-mitr font-regular border border-slate-600 text-[#2C2C2C] bg-[#FFE3DE] p-3">Coin</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="font-mitr font-regular border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-3">Book</td>
                        <td class="font-mitr font-regular border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-3">Book@gmail.com</td>
                        <td class="font-mitr font-regular border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-3">1234</td>
                        <td class="font-mitr font-regular border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-3">10</td>
                        <td class="font-mitr font-regular border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-3">Admin</td>
                        <td class="font-mitr font-regular border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-3">
                            <button class="font-mitr font-regular bg-[#6CAAF0] text-white px-4 py-1 rounded mr-2">Manage</button>
                            <button class="font-mitr font-regular bg-[#BD4C52] text-white px-4 py-1 rounded">Delete</button>
                        </td>
                    </tr>
                    <tr>
                        <td class="font-mitr font-regular border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-3">002</td>
                        <td class="font-mitr font-regular border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-3">Pui</td>
                        <td class="font-mitr font-regular border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-3">Pui@gmail.com</td>
                        <td class="font-mitr font-regular border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-3">1234</td>
                        <td class="font-mitr font-regular border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-3">10</td>
                        <td class="font-mitr font-regular border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-3">User</td>
                        <td class="font-mitr font-regular border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-3">
                            <button class="font-mitr font-regular bg-[#6CAAF0] text-white px-4 py-1 rounded mr-2">Manage</button>
                            <button class="font-mitr font-regular bg-[#BD4C52] text-white px-4 py-1 rounded">Delete</button>
                        </td>
