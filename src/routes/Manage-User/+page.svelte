            ...
            <div class="flex items-center space-x-4 md:space-x-6 lg:space-x-8">
                ...
                <button>
                    <a href="/Manage-Products">
                        <h1 class="font-mitr font-regular text-sm md:text-lg lg:text-xl text-[#2C2C2C]">Manage-Products</h1>
                    </a>
                </button>

                <button>
                    <a href="/Manage-User">
                        <h1 class="underline font-mitr font-regular text-sm md:text-lg lg:text-xl text-[#2C2C2C]">Manage-User</h1>
                    </a>
                </button>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="font-mitr font-regular border border-slate-600 text-[#2C2C2C] bg-[#FFFFFF] p-3">
                            ...
                            <button class="font-mitr font-regular bg-[#98BC79] text-[#FFFFFF] px-4 py-1 rounded mr-2">Change Password</button>
                        </td>
                    </tr>
                    <tr>
